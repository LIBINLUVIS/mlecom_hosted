...
function Cart() {
  let {userstate, cartitems, user, itemadd } = useContext(UserContext);
  ...
  return (
    <div class="flex justify-center align-center p-10 w-full" style={{ minHeight: "100vh" }}>
                ...
                <>
                  {cartitems.map((item) => (
                    <div class="w-full px-2">
                      {/* FIXME: */}
                      <div class="flex  justify-between items-center mt-6 pt-6" id="mobviewcart">
                      {/* FIXME: */}
                        ...
                        <div class="flex  justify-center items-center" id="mobviewbtns"> 
                          <div class="pr-8 flex">
                            <button
                              onClick={() => {
                                incqty(item.id, "sub");
